...
<div>
    <form method="post" action="{{ url('/updatePharmacie', $pharmacie->id)}}">
        <input type="hidden" value="{{csrf_token()}}" name="_token" id="token" />
        <label>Modifier un Pharmacie</label><br><br>
        <input type="text" value="{{ $pharmacie->name }}" name="name"><br><br>
        <input type="text" value="{{ $pharmacie->phone }}" name="phone"><br><br>
        <input type="text" value="{{ $pharmacie->adresse }}" name="address"><br><br>
        <label for="story">Description:</label><br>
        <textarea id="story" rows="5" cols="33"  name="description">{{ $pharmacie->description }}</textarea><br><br>
        <select name="commune">
            <option value="{{ $pharmacie->communes->id }}">{{ $pharmacie->communes->name }}</option>
        </select><br><br>
        <input type="text" placeholder="Adresse" name="adresse" id="adresse"><br><br>
        <input id="lat" type="text" value="{{ $pharmacie->latitude }}" placeholder="Latitude" name="lat" readonly><br><br>
        <input id="lng" type="text" value="{{ $pharmacie->longitude }}" placeholder="Longitude" name="lng" readonly><br><br>
